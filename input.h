...
void key_callback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
    ...
    bool is_pressed = (action == GLFW_PRESS) ? true : false;
    switch(key){
        case GLFW_KEY_W:
        case GLFW_KEY_UP:       g_input[MOVE_UP]        = is_pressed; return;
        case GLFW_KEY_A:
        case GLFW_KEY_LEFT:     g_input[MOVE_LEFT]      = is_pressed; return;
        case GLFW_KEY_S:
        case GLFW_KEY_DOWN:     g_input[MOVE_DOWN]      = is_pressed; return;
        case GLFW_KEY_D:
        case GLFW_KEY_RIGHT:    g_input[MOVE_RIGHT]     = is_pressed; return;
        case GLFW_KEY_L:        g_input[DASH_MOVE]      = is_pressed; return;
        default: break;
    }
    //Custom key mapping:
